...
class NOPCreate extends StatefulWidget {
  // final String name;
  // final String prosId;
  const NOPCreate({
    Key key,
  ...
  @override
  State<NOPCreate> createState() => _NOPCreateState();
}

class _NOPCreateState extends State<NOPCreate> {
  List<Coverage> cover = [];
          ...
          : Container(
              ...
              child: ListView(
                ...
                autovalidateMode: AutovalidateMode.onUserInteraction,
                  ...
                  SizedBox(height: 15),
                  labelText(label: 'Commencement Date'),
                  TextFormField(
