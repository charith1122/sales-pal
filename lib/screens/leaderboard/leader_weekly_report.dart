...
class LeaderWeeklyReports extends StatefulWidget {
  final String id;
  final String name;
  final String regNo;
  final String company;
  final String contact;
  const LeaderWeeklyReports(
  ...
  @override
  State<LeaderWeeklyReports> createState() => _LeaderWeeklyReportsState();
}

class _LeaderWeeklyReportsState extends State<LeaderWeeklyReports> {
  int selectedVal;
  ...
  getAnnualPlan() async {
    try {
      ...
      await APIs()
          .getMonthReport(
              userId: widget.id, year: _chosenValue, month: _chosenMonth)
          .then((value) {
        if (value.done) {
